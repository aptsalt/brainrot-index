        ...
        {!score ? (
          ...
          >
            ...
            >
              ...
              <p
                className="text-xs font-mono mt-3 tracking-wider uppercase"
                style={{ color: "var(--muted)" }}
              >
                [ cognitive chaos quantifier ]
              </p>
              <p
                className="text-sm max-w-sm mx-auto mt-3 leading-relaxed"
          ...
          /* === RESULTS VIEW — compact header, grid layout === */
          <motion.div
            key="result"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0, y: 20 }}
            className="w-full max-w-4xl score-reveal"
          >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              >
                <span className="text-lg font-black comic-bang bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent">
                  BrainRot Index
                </span>
              </button>
              <div
                ...
                style={{ color: "var(--muted)" }}
              >
                Diagnosis #{Math.floor(Math.random() * 9999)
                  .toString()
                  .padStart(4, "0")}
              </div>
            </div>
